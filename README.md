In this notebook, we have tried to solve the breast cancer classification problem using the three popular machine learning classifiers : KNN, Logistic Regression,SVM.
